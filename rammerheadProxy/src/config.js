...
module.exports = {
    ...
    fakeIpAddress: "83.51.26.21",
    bindingAddress: '127.0.0.1',
    port: process.env.PORT,
    crossDomainPort: null,
    publicDir: path.join(__dirname, '../static'), // set to null to disable
    ...
    // cloudflare example:
    stripClientHeaders: ['cf-ipcountry', 'cf-ray', 'x-forwarded-proto', 'cf-visitor', 'cf-connecting-ip', 'cdn-loop', 'Content-Disposition'],
